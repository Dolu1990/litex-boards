    ...
    def __init__(self, sys_clk_freq=100e6,
        ...
        **kwargs):
        ...
        if hasattr(self.cpu, "eth_tx_ref_clk"):
            ...
            # self.comb += self.cpu.eth_rx_clk .eq(self.crg.cd_eth.clk)
            # self.comb += self.cpu.eth_rx_ctl.eq(self.cpu.eth_tx_ctl)
            # self.comb += self.cpu.eth_rx_d.eq(self.cpu.eth_tx_d)
